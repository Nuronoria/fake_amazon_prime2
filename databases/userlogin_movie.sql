...
CREATE TABLE `movie` (
  ...
  `Movie_picture` varchar(45) NOT NULL,
  `Movie_banner` varchar(45) NOT NULL,
  `Movie_release` date NOT NULL,
  `Movie_trailerURL` varchar(100) DEFAULT NULL,
...
INSERT INTO `movie` VALUES (1,'test','testtesttesttest','nichts','nichst','2017-06-15','NULL');
